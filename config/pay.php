...
return [
    'alipay' => [
        ...
        // 自己的私钥，签名时使用
        'private_key' => env('ALI_PRIVATE_KEY', base_path('certs/private.pem')),
    ...
    'wechat' => [
        ...
        'cert_client' => '/data/yugong-backend/certs/apiclient_cert.pem',

        // 客户端秘钥路径，退款、红包等需要用到。请填写绝对路径，linux 请确保权限问题。pem 格式。
        'cert_key' => '/data/yugong-backend/certs/apiclient_key.pem',
